...
if( !empty($_POST)) {
    ...
    $origin = $_POST['origin'];
    $architecture = implode(",", array($_POST['architecture[]']));
    ...
    // Validate if the distro webpage is empty
    if (empty($web)) {
        $errors['web']['empty_web'] = 'La pagina web de la distro esta vacia';
    }
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO distro (image, name, ostype, based, origin, arch, desktop, category, status, version, main_page, doc, forums, error_tracker, description)
                VALUES (:image, :distroname, :ostype, :basedon, :origin, :architecture, :desktop, :category, :status, :version, :web, :doc, :forum, :error, :description)";
...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="ostype" id="inputOsType">
